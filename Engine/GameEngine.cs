...
namespace GameEngine
{
    ...
    //Vector4
    public struct Rectanglef : IDisposable
    {
        private float m_X;
        public float X
        {
    ...
    public class GameEngine : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            for (int ik = 0; ik < m_GameObjects.Count; ++ik)
                m_GameObjects[ik].GameEnd();
    ...
    public class GameObject
    {
        ...
        /// </summary>
        protected static GameEngine GAME_ENGINE
        {
    ...
    public class Audio : IDisposable, ISampleProvider
    {
        ...
        public void SetVolume(float volume)
        {
            ...
            for (int im = 0; im < m_OriginalData.Length; ++im)
            {
                m_Data[im] = m_OriginalData[im] * volume;
            }
        }
